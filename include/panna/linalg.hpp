...
namespace panna {
    ...
    inline static int16_t dot_product_chunks16_avx2( UnitNormPointHandle lhs,
        ...
        __m256i res = _mm256_mulhrs_epi16(
            _mm256_load_si256( (__m256i*)&lhs.chunks[0] ),
            _mm256_load_si256( (__m256i*)&rhs.chunks[0] ) );
        for ( size_t i = 1; i < lhs.num_chunks; i += 1 ) {
            __m256i tmp = _mm256_mulhrs_epi16(
                _mm256_load_si256( (__m256i*)&lhs.chunks[i] ),
                _mm256_load_si256( (__m256i*)&rhs.chunks[i] ) );
    ...
    static int16_t dot_product_chunks16( UnitNormPointHandle lhs,
                                         UnitNormPointHandle rhs ) {
#ifdef __AVX2__
